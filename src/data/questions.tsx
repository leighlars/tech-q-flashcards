export const questions = {
  be: [
    ...
    "Here at Turing you have used two types of testing Minitest and RSpec.", 
    "Please give your opinion/comparison of the two.",
    "My production and development environments are using large sets of data.", 
    "What are some ways to optimize my tests to run quickly, but be thorough?",
    "What is a Mock vs. a Stub in testing?",
    "When would you use each?",
    "What is yield in Ruby?", 
    "What is it useful for?", 
    "Give an example of where you would put it.",
