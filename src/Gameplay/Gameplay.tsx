...
export const Gameplay: React.FC<GameplayProps> = props => {
  ...
  return(
    <div className='gameplay-modal'>
      ...
      <p>- Play alone or play with friends via video conferencing</p>
      ...
      <p>- Other players may privately message interviewer their thoughts on candidate to add to comments box</p>
      <p>- Each round has 5 questions</p>
      <p>- Interviewer will add notes once interview is complete, click 'add', and notes will render</p>
      <p>- At the end of the round, the interviewer will be alerted to compile group notes and submit in form</p>
